...
<div class="wrapper">
  ...
  <div class="row">
    <div class="col-12 text-center bg-secondary pt-1 pb-1 mt-2">
      <h3>Your catagory Contents</h3>
    </div>
    <div class="col-12 mt-2 ml-3">
      <a href="/custom/mvc/admin/create-catagory" class="btn btn-primary"> Add new catagory </a>
    </div>
    ...
    <?php include_once 'components/index-body.php'; ?>
  </div>
...
<script>
  ...
  //   let delete_id = $('#delete').attr('delete-id');
  //   // let form = $(".delete-modal");
  //   // form.attr('action','/custom/mvc/admin/secret/'+delete_id+'/delete');

  //   let link = $('#delete-link');
  //   link.attr('href','/custom/mvc/admin/secret/'+delete_id+'/delete');
  // })
  ...
  $('#DeleteModal').on('show.bs.modal',function(event){
    ...
    form.attr('href','/custom/mvc/admin/catagory/'+id+'/delete');
  });
</script>
