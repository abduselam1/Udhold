...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="row">
        ...
        <h3>Your secret Contents</h3>
        </div>
        <div class="col-12 mt-2 ml-3">
        <a href="/custom/mvc/admin/create-secret" class="btn btn-primary"> Add new secret </a>
        </div>
        
    </div>

    <form action="/custom/mvc/admin/secret/<?=$data['secret']->id?>/update" class="" method="post" enctype="multipart/form-data">
