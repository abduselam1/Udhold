...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/custom/mvc/home" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/custom/mvc/contact-us" class="nav-link">Contact</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="/custom/mvc/public/image/logo40.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/custom/mvc/<?=$data['user']->profile?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/custom/mvc/admin/catagorys" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Catagory</p>
                </a>
              </li>
    ...
    <section class="content">
      <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12">
                <form action="/custom/mvc/admin/post/<?php echo $data['post']->id; ?>/update" method="post" enctype="multipart/form-data">
                    <?php include_once('components/dashboard/create-new-post.php'); ?>
                    <button type="submit" id="update-post" class="btn btn-outline-success ">Update</button>
                </form>
                </div>
