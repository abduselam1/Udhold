            ...
            <div class="row">
                    <div class="col-12 mt-2 justify-content-center">
                        <div class="text-center pt-3 pb-3 bg-secondary">
                            <h1>Detail of Your post</h1>
                        </div>
                    </div>
                    <div class="col-12">
                        <a class="btn btn-sm btn-warning mt-2 mb-1 ml-2" href="/custom/mvc/admin/post/<?=$data['post']->id?>/edit" type="submit"><i class="fas fa-edit" ></i> Edit</a>
                    </div>
                    <?php include_once('components/show-post.php'); ?>
